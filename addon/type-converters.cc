...
int32_t NodeDuckDB::TypeConverters::convertNumber(const Napi::Env &env, const Napi::Object &options, const string propertyName)
{
...
bool NodeDuckDB::TypeConverters::convertBoolean(const Napi::Env &env, const Napi::Object &options, const string propertyName)
{
...
int32_t NodeDuckDB::TypeConverters::convertEnum(const Napi::Env &env, const Napi::Object &options, const string propertyName, const int min, const int max)
{
...
void NodeDuckDB::TypeConverters::setDBConfig(const Napi::Env &env, const Napi::Object &config, duckdb::DBConfig &nativeConfig)
{
